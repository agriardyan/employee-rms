...
//        mockMvc = MockMvcBuilders.standaloneSetup(employeeController).build();
    ...
    @Test
    public void itShouldReturn200() throws Exception {
        ...
        given()
                ...
                .assertThat(mvcResult -> {
                    ...
                    assertEquals(emp.length, 1);
                    assertEquals(emp[0], this.employee);
                });
    ...
    @Test
    public void itShouldReturn200Empty() throws Exception {
        ObjectMapper objectMapper = new ObjectMapper();
        ...
        given()
                ...
                .standaloneSetup(this.employeeController)
                .when()
                .get("/employee/fetch/" + empid)
                .then()
                .statusCode(200)
                .contentType(ContentType.JSON)
                .assertThat(mvcResult -> {
                    Employee[] emp = objectMapper.readValue(mvcResult.getResponse().getContentAsString(), Employee[].class);
                    assertEquals(emp.length, 0);
                });
    }
